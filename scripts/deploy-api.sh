...
required=(DATABASE_APP_URL AZURE_OPENAI_ENDPOINT AZURE_OPENAI_API_KEY AZURE_OPENAI_API_VERSION
...
for name in DATABASE_APP_URL AZURE_OPENAI_ENDPOINT AZURE_OPENAI_API_KEY AZURE_OPENAI_API_VERSION \
            AZURE_OPENAI_DEPLOYMENT AZURE_OPENAI_EMBEDDING_DEPLOYMENT GEMINI_API_KEY GEMINI_MODEL \
            ELEVENLABS_API_KEY ELEVENLABS_VOICE_ID ELEVENLABS_VOICE_ID_SPANISH \
            ELEVENLABS_TTS_MODEL ELEVENLABS_STT_MODEL \
            FISH_AUDIO_API_KEY FISH_AUDIO_VOICE_ID FISH_AUDIO_VOICE_ID_SPANISH \
